...
created: 2026-05-11
updated: 2026-05-11
source: 10_Sources/roadmaps/full-stack/content/checkpoint---frontend-apps@7JU1cVggMDoZUV-adGsf-.md
---
...
If you decided to skip React and Tailwind for now, that is fine also but you should be able to build a complete frontend application using vanilla HTML, CSS, and JavaScript. However, keep in mind that the modern frontend applications are mostly built with frameworks like React, Vue, and Angular. So,
 you should learn at least one of them at any point of time.
