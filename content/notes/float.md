...
---
## 상세 내용 (Merged from 20_Wiki/Develop/References/dart2/dart-html/cssstyledeclarationbase/float.md)
...
---
## 상세 내용 (Merged from 20_Wiki/Develop/References/dart2/dart-ffi/float/float.md)
...
© 2012 the Dart project authors\
Licensed under the BSD 3-Clause \"New\" or \"Revised\" License.\
<https://api.dart.dev/stable/2.18.5/dart-ffi/Float/Float.html>
:::
