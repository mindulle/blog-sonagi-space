...
created: 2026-05-11
updated: 2026-05-11
source: 10_Sources/roadmaps/engineering-manager/content/defining-and-enforcing-values@ZuZuzwy-Frsn_PFJZVuAQ.md
---

# Defining and Enforcing Values

An Engineering Manager plays a critical role in defining and enforcing the values of the team they lead. They're responsible for setting the tone for a culture where these values are understood and practiced by all members. They will often work hand-in-hand with HR and leadership to craft a set of v
alues that align with the broader organization's vision and purpose.
