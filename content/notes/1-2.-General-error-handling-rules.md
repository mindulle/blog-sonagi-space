...
> Services must return a [google.rpc.Status](https://github.com/googleapis/api-common-protos/blob/master/google/rpc/status.proto) message when an API error occurs, and must use the canonical error codes defined in [google.rpc.Code](https://github.com/googleapis/api-common-protos/blob/master/google/r
pc/code.proto).
