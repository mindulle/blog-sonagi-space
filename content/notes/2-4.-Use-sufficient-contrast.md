...
2. In the contrast checker, enter the following Hex colors to find out which foreground-background ratios meet contrast requirements. Record the contrast ratios on a notepad or separate document to compare your answers with the [possible answers](https://developers.google.com/tech-writing/accessibil
ity/self-study/sufficient-contrast#answers).
