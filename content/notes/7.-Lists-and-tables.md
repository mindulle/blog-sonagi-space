...
Though different style guides offer conflicting advice about punctuating list items, the [Google developer documentation style guide](https://developers.google.com/style/lists#capitalization-and-end-punctuation) recommends (with some exceptions) starting each list item with a capital letter. For exa
mple:
