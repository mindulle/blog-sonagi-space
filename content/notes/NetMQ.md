...
created: 2026-05-11
updated: 2026-05-11
source: 10_Sources/roadmaps/aspnet-core/content/netmq@8d4f7_3VO03vy7YDWwPI9.md
---
...
NetMQ is built on top of ZeroMQ, a high-performance, asynchronous messaging library that provides a minimalistic socket-based API for building distributed systems. NetMQ is designed to be easy to use and to abstract away the complexities of ZeroMQ, making it a good choice for developers who want to 
add messaging capabilities to their [ASP.NET](http://ASP.NET) applications without having to learn a complex API.
