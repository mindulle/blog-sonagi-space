...
created: 2026-05-11
updated: 2026-05-11
source: 10_Sources/roadmaps/api-design/content/handling-crud-operations@zXxEiM5HeOn7W-Vue0tQf.md
---

# Handling CRUD Operations in API Design

When designing APIs, one needs to account for various types of interactions with data - these typically revolve around the CRUD operations; Create, Read, Update, and Delete. Whether the API is designed for a banking app or a social media platform, the need to create new data, read or retrieve existi
ng data, update or modify that data, and delete unnecessary data is universal.
