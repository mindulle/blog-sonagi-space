---
title: "What Is The Order Priority Of `process.nextTick`, `Promise`, `setTimeout`, And `setImmediate`"
date: 2025-10-27
tags: [nodejs, internals, promise]
category: dev
description: "Order priorities of `process.nextTick`, `Promise`, `setTimeout` and `setImmediate` are as follows:"
---
...
---
## 상세 내용 (Merged from 20_Wiki/Develop/Frontend/tree/Under the hood/Nodejs/What is the order priority of `process.nextTick`, `Promise`, `setTimeout`, and `setImmediate`.md)
Order priorities of `process.nextTick`, `Promise`, `setTimeout` and `setImmediate` are as follows:
