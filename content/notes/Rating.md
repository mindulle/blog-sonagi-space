...
<div class="Rating">
  ...
  <button class="Star" type="button" tabindex="-1" aria-label="Rating 1 of 5">
    <svg class="icon" width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M10.877 2.696l-2.55 5.171-5.707.832c-1.023.148-1.433 1.41-.691 2.132l4.128 4.023-.976 5.683c-.176 1.027.906 1.797 1.812 1.317l5.105-2.684 5.105 2.683c.906.477 1.988-.289 1.812-1.316l-.976-5.683 4.128-4.023c.742-.722.332-1.984-.691-2.132l-5.707-.832-2.55-5.171c-.457-.922-1.781-.934-2.242 0
z"
        fill="#E5A800"
      />
    </svg>
