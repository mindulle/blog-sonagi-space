...
Providing a proper title, description, screenshots, relevant links, and configuration changes helps reviewers quickly grasp the purpose, functionality, and any other important context associated with the changes introduced by the PR. To ensure the quality and effectiveness of your PR documentation, 
...
---
## 상세 내용 (Merged from 20_Wiki/Develop/_commons/fruit/Review/Best Practices/After the Development (Author)/proper-description-pr.md)
# About Pull Requests
