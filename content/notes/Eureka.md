...
created: 2026-05-11
updated: 2026-05-11
source: 10_Sources/roadmaps/spring-boot/content/eurkea@6sLE6gb5Y477SmO2GhQIG.md
---
...
Eureka is a service registry that allows service instances to register themselves and to discover other services by name. It provides a simple, consistent way for services to find and communicate with each other, and it integrates with other Spring Cloud libraries such as Ribbon and Feign to provide
 load balancing and declarative REST clients.
