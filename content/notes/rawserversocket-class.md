...
A `RawServerSocket` and provides a stream of low-level
[RawSocket](rawsocket-class) objects, one for each connection made to
the listening socket.

See [RawSocket](rawsocket-class) for more info.

Implemented types

:   -   [Stream](../dart-async/stream-class)\<[RawSocket](rawsocket-class)\>

Constructors
------------

[RawServerSocket](rawserversocket/rawserversocket)()

Properties {#instance-properties}
----------

[address](rawserversocket/address) →
...
[port](rawserversocket/port) → [int](../dart-core/int-class)
...
test([RawSocket](rawsocket-class) element)) →
[Future](../dart-async/future-class)\<[bool](../dart-core/bool-class)\>
...
onListen([StreamSubscription](../dart-async/streamsubscription-class)\<[RawSocket](rawsocket-class)\>
subscription)?, void
onCancel([StreamSubscription](../dart-async/streamsubscription-class)\<[RawSocket](rawsocket-class)\>
subscription)?}) →
[Stream](../dart-async/stream-class)\<[RawSocket](rawsocket-class)\>
...
convert([RawSocket](rawsocket-class) event)) →
...
equals([RawSocket](rawsocket-class) previous,
[RawSocket](rawsocket-class) next)?\]) →
[Stream](../dart-async/stream-class)\<[RawSocket](rawsocket-class)\>
...
convert([RawSocket](rawsocket-class) element)) →
...
test([RawSocket](rawsocket-class) element),
{[RawSocket](rawsocket-class) orElse()?}) →
[Future](../dart-async/future-class)\<[RawSocket](rawsocket-class)\>
...
previous, [RawSocket](rawsocket-class) element)) →
...
action([RawSocket](rawsocket-class) element)) →
...
onData([RawSocket](rawsocket-class) event)?,
{[Function](../dart-core/function-class)? onError, void onDone()?,
[bool](../dart-core/bool-class)? cancelOnError}) →
[StreamSubscription](../dart-async/streamsubscription-class)\<[RawSocket](rawsocket-class)\>
...
[pipe](../dart-async/stream/pipe)([StreamConsumer](../dart-async/streamconsumer-class)\<[RawSocket](rawsocket-class)\>
...
[reduce](../dart-async/stream/reduce)([RawSocket](rawsocket-class)
combine([RawSocket](rawsocket-class) previous,
[RawSocket](rawsocket-class) element)) →
[Future](../dart-async/future-class)\<[RawSocket](rawsocket-class)\>
...
timeLimit, {void
onTimeout([EventSink](../dart-async/eventsink-class)\<[RawSocket](rawsocket-class)\>
sink)?}) →
[Stream](../dart-async/stream-class)\<[RawSocket](rawsocket-class)\>
...
[Future](../dart-async/future-class)\<[List](../dart-core/list-class)\<[RawSocket](rawsocket-class)\>\>
...
[Future](../dart-async/future-class)\<[Set](../dart-core/set-class)\<[RawSocket](rawsocket-class)\>\>
...
[transform](../dart-async/stream/transform)\<S\>([StreamTransformer](../dart-async/streamtransformer-class)\<[RawSocket](rawsocket-class),
...
test([RawSocket](rawsocket-class) event)) →
[Stream](../dart-async/stream-class)\<[RawSocket](rawsocket-class)\>
...
[bind](rawserversocket/bind)(dynamic address, [int](../dart-core/int-class) port, {[int](../dart-core/int-class) backlog = 0, [bool](../dart-core/bool-class) v6Only = false, [bool](../dart-core/bool-class) shared = false}) → [Future](../dart-async/future-class)\<[RawServerSocket](rawserversocket-cla
ss)\>
...
<https://api.dart.dev/stable/2.18.5/dart-io/RawServerSocket-class.html>
:::
