...
created: 2026-05-11
updated: 2026-05-11
source: 10_Sources/roadmaps/software-architect/content/linux--unix@XnvlRrOhdoMsiGwGEhBro.md
---

# Linux / Unix

Knowledge of UNIX is a must for almost all kind of development as most of the codes that you write is most likely going to be finally deployed on a UNIX/Linux machine. Linux has been the backbone of the free and open source software movement, providing a simple and elegant operating system for almos
t all your needs.
