...
created: 2026-05-11
updated: 2026-05-11
source: 10_Sources/roadmaps/data-engineer/content/data-modelling-techniques@SlQHO8n97F7-_fc6EUXlj.md
---

# Data Modelling Techniques

A data model is a specification of data structures and business rules. It creates a visual representation of data and illustrates how different data elements are related to each other. Different techniques are employed depending on the complexity of the data and the goals. Below you can find a list 
with the most common data modelling techniques:
