...
created: 2026-05-11
updated: 2026-05-11
source: 10_Sources/roadmaps/qa/content/chrome-devtools@Xadg2WZTz6Cc_Ir9FsbgY.md
---
...
`cmd+opt+j` to enter it directly). Another very useful feature in the Chrome dev tools is the Lighthouse (for checking performance) — more on this later.
