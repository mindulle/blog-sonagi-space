...
created: 2026-05-11
updated: 2026-05-11
source: 10_Sources/roadmaps/aspnet-core/content/nlog@ykF2bB_68AhCOzeQ_QSW1.md
---
...
NLog is a powerful, flexible, and easy-to-use logging library that can be used in [ASP.NET](http://ASP.NET) applications to provide detailed log data. It allows developers to easily configure their logging pipeline, and to write log data to a variety of destinations, making it easier to analyze and 
