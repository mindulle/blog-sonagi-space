...
more complex animations like bounce an
d elastic effects. The
...
often called \"smooth\" easing functions b
ecause they can be used to
...
these points are f
ixed as the coordinates progress (the abscissa the
...
and P3 fixed as d
efined by CSS, a cubic Bézier curve is a function, and
...
a
n allowable range. For example, a color component greater than `255` or
...
startBtn.addEventListener("click", () => {
  if (startBtn.textContent === "Start animation") {
    divElem.style.animationName = "move-ri
ght";
...
```css
/* The canonical Bézier curve with four <num
ber> in the [0,1] range */
...
or later.\
https://developer.mozilla.org/en-US/docs/Web/CSS/easi
ng-function>
