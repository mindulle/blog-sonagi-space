...
In the process of code review, it is crucial to have a solid understanding of the codebase and its architecture. Familiarizing yourself with the overall structure, design patterns, and key components ensures that you can identify potential issues and provide meaningful feedback to improve the qualit
y of the code. To make sure you have a good grasp of the codebase and its architecture, consider the following tips:
...
---
## 상세 내용 (Merged from 20_Wiki/Develop/_commons/fruit/Review/Best Practices/Before Reviewing (Reviewer)/architecture-understanding.md)
# Understand the Codebase Architecture
