...
created: 2026-05-11
updated: 2026-05-11
source: 10_Sources/roadmaps/software-architect/content/spa-ssr-ssg@ulwgDCQi_BYx5lmll7pzU.md
---
...
*   **SSR**: This technique uses a server like `Node.js` to fully render the web document upon the receival of a request and then send it back to the client. This way the user get an interactive document with all the necessary information without having to wait for any JavaScript or CSS files to loa
d.
