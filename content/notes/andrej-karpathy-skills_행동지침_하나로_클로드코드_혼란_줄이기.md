---
title: 'andrej-karpathy-skills: 행동지침 하나로 클로드코드 혼란 줄이기'
url: 'https://americanopeople.tistory.com/514'
source: 'Discord Web Clipper'
clipped_at: '2026-06-27 16:34:57'
---

[본문 바로가기](https://americanopeople.tistory.com/514#content)
...
americano_people 2026\. 4. 25. 17:12

> [andrej-karpathy-skills](https://github.com/forrestchang/andrej-karpathy-skills)
> 스킬을 읽고, 이해한 내용을 정리해보자!

# AI 코딩 작업의 한계 

OpenAI의 공동 창업자인 `안드레 카파시`는 2026년 1월 27일, AI의 한계에 대한 글을 남겼다. LLM으로 코딩 능력이 많이 향상되었지만, 아직은 완전하지 않다고 의견을 제시했다. 

약간 산만하고 성급한 주니어 개발자가 할법한 미묘한 작업 실수들이 있어서, 작업 결과물을 감시해야 하는 경우가 있다고 말이다. 

![](https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdna%2Fccvipw%2FdJMcacpmpfA%2FAAAAAAAAAAAAAAAAAAAAAANk5-PqaVt3YFAMIwlxvAzkFE4IiOCUJtyfYGQThgVN%2Fimg.png%3Fcredential%3DyqXZFxpELC7KVnFOS48ylbz2pIh7yKj8%26expires%3D1782831599%26allow_ip%3D%26allow_referer%3D%26signature%3D4mfuApVlw4q54IcPknwj%252FtyHOe0%253D)
...
자신의 [CLAUDE.md](https://github.com/forrestchang/andrej-karpathy-skills/blob/main/CLAUDE.md)
에 지침을 복사 붙여넣기 하면 된다. 
...
\
x.com](https://x.com/karpathy/status/2015883857489522876?s=20)
...
[](https://americanopeople.tistory.com/514#none)
[](https://americanopeople.tistory.com/514#none)
...
|                          |            |
| ------------------------ | ---------- |
| 글 수정 (권한 있는 경우) | E<br><br>E |
| 댓글 영역으로 이동       | C<br><br>C |

### 모든 영역

|                      |                        |
| -------------------- | ---------------------- |
| 이 페이지의 URL 복사 | S<br><br>S             |
| 맨 위로 이동         | T<br><br>T             |
| 티스토리 홈 이동     | H<br><br>H             |
| 단축키 안내          | Shift + /<br><br>⇧ + / |
