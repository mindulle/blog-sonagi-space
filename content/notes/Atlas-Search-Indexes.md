...
created: 2026-05-11
updated: 2026-05-11
source: 10_Sources/roadmaps/mongodb/content/atlas-search-indexes@YidhAuVk_VGukx_FfJSz2.md
---

# Atlas Search Indexes

Atlas Search indexes in MongoDB Atlas provide full-text search capabilities using Apache Lucene technology. They enable sophisticated text search with relevance scoring, autocomplete, faceted search, and synonyms. These indexes support complex search queries across multiple fields, fuzzy matching, a
nd advanced text analysis features for building modern search experiences in applications.
