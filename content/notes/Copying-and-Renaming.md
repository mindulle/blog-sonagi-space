...
created: 2026-05-11
updated: 2026-05-11
source: 10_Sources/roadmaps/linux/content/copying-renaming@abKO6KuuIfl9ruVxBw6t_.md
---

# Copying and Renaming Files

Essential Linux file operations use `cp` to copy files and `mv` to move/rename them. The `cp` command copies files from source to destination, while `mv` moves or renames files/directories. Both commands use the syntax `command source destination`. These case-sensitive commands are fundamental for d
aily file management tasks in Linux systems.
