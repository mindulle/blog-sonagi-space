---
title: "How Do You Investigate A Slow React App And Identify Performance Bottlenecks"
date: 2025-10-27
tags: [react, performance, lazy, rendering, component, api]
category: dev
description: "There are many reasons why an app might be slow. It could be due to a slow network, a slow backend, or a slow client. It could also be due to a memory..."
---
...
Ensure that components don't render more often than needed. Be clear about the `useEffect` dependencies and avoid creating new objects or arrays every render, as these can trigger unnecessary child component renders. Tools like [why-did-you-render](https://npm.im/@welldone-software/why-did-you-rende
r) can help spot unnecessary re-renders.
...
---
## 상세 내용 (Merged from 20_Wiki/Develop/Frontend/tree/Perf-opt/React/How do you investigate a slow React app and identify performance bottlenecks.md)
There are many reasons why an app might be slow. It could be due to a slow network, a slow backend, or a slow client. It could also be due to a memory leak, unnecessary re-renders, or large bundle sizes.
