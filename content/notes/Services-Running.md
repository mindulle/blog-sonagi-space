...
created: 2026-05-11
updated: 2026-05-11
source: 10_Sources/roadmaps/linux/content/services-running@ewUuI_x-YhOQIYd3MTgJJ.md
---

# Running Services

Linux servers run various services including web, database, DNS, and mail servers. System administrators use tools like `systemctl`, `service`, `netstat`, `ss`, and `lsof` to manage and monitor services. Use `systemctl --type=service` to list all active services with their status. Essential for serv
er management, resource monitoring, and troubleshooting.
