      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          <section>
            ...
            <p>
              소나기 블로그는 별도의 회원가입 없이 서비스를 이용할 수 있습니다.
              다만, 서비스 이용 과정에서 다음과 같은 정보들이 자동으로 생성되어
              수집될 수 있습니다.
            </p>
          ...
          <section>
            ...
            <p>
              ...
              달성되면 지체 없이 파기합니다. 단, 관련 법령에 의해 보존할 필요가
          ...
          <section>
            ...
            <p>
              본 블로그는 이용자에게 개인화된 서비스를 제공하기 위해 쿠키를
              사용합니다. 쿠키는 웹사이트를 운영하는데 이용되는 서버가 이용자의
              브라우저에 보내는 아주 작은 텍스트 파일로 이용자의 컴퓨터
              하드디스크에 저장됩니다.
            </p>
            <p>
              이용자는 쿠키 설치에 대한 선택권을 가지고 있으며, 웹 브라우저
          ...
          <section>
            ...
            <p>
              본 서비스는 기능 제공을 위해 Pinterest API 등 제3자 서비스를
              이용할 수 있습니다. 이 과정에서 해당 서비스 제공업체의 정책에 따라
              정보가 처리될 수 있습니다. 각 서비스의 개인정보 정책은 해당
              서비스의 공식 웹사이트를 참조하시기 바랍니다.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              개인정보보호와 관련하여 궁금하신 사항은 아래의 연락처로 문의해
              주시기 바랍니다.
            </p>
            <p className="mt-2">
              이메일:{' '}
              <a
                href="mailto:hello@sonagi.space"
